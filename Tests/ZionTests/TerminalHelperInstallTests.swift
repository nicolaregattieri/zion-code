...
final class TerminalHelperInstallTests: XCTestCase {
    ...
    func testInstallScriptsRefreshesGlobalZionImgHelpersWithPreviewFirstPrompt() throws {
        ...
        XCTAssertTrue(codexSkill.contains("displayed in Zion's built-in image preview automatically"))
        XCTAssertTrue(claudeCommand.contains("displayed in Zion's built-in image preview automatically"))
        XCTAssertTrue(geminiCommand.contains("displayed in Zion's built-in image preview automatically"))
