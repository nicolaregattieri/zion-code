    ...
    static func entries(for section: FeatureSection) -> [ZionMapEntry] {
        ...
        case .code:
            return [
                ...
                ZionMapEntry("map.code.markdownreader.title", description: "map.code.markdownreader.description",
                             shortcut: "\u{21E7}\u{2318}M",
                             tips: ["map.code.markdownreader.tip1", "map.code.markdownreader.tip2"]),
        ...
        case .chat:
            return [
                ...
                ZionMapEntry("map.chat.slashAutocomplete.title", description: "map.chat.slashAutocomplete.description"),
