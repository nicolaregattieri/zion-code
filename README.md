...
| **AI** | None or paid addon | 13 AI features (Claude / GPT / Gemini), free to configure |
...
| **Hosting** | GitHub only | GitHub + GitLab + Bitbucket + Azure DevOps with auto-detection |
...
### AI Assistant
> 13 features. 3 providers. Free to configure.
